...
from summerclaw.agent.complexity import LLMComplexityEvaluator, is_complex_task
...
from summerclaw.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
...
from summerclaw.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from summerclaw.agent.tools.message import MessageTool
from summerclaw.agent.tools.notebook import NotebookEditTool
from summerclaw.agent.tools.registry import ToolRegistry
from summerclaw.agent.tools.search import GlobTool, GrepTool
from summerclaw.agent.tools.shell import ExecTool
from summerclaw.agent.tools.self import MyTool
from summerclaw.agent.tools.spawn import SpawnTool
...
from summerclaw.agent.tools.web import WebFetchTool, WebSearchTool
from summerclaw.bus.events import InboundMessage, OutboundMessage
from summerclaw.bus.queue import MessageBus
from summerclaw.command import CommandContext, CommandRouter, register_builtin_commands
...
from summerclaw.utils.document import extract_documents
from summerclaw.utils.helpers import image_placeholder_text
from summerclaw.utils.helpers import truncate_text as truncate_text_fn
from summerclaw.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from summerclaw.config.schema import ChannelsConfig, ExecToolConfig, ProxyPoolConfig, SkillAutogenConfig, ToolsConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from summerclaw.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        from summerclaw.config.schema import BrowserToolsConfig, ExecToolConfig, ProxyPoolConfig, ToolsConfig, WebToolsConfig
        ...
        from summerclaw.memory import _HAS_EMEM, _HAS_REME
        ...
        if self._planner is not None and max_replan_iterations > 0:
            from summerclaw.agent.evaluator import TaskEvaluator
        ...
        if self._planner is not None:
            from summerclaw.agent.search_planner import SearchEnhancedPlanner
    ...
    def _register_default_tools(self) -> None:
        ...
        if self.browser_config.enable:
            from summerclaw.agent.tools.browser import BrowserFetchTool, BrowserSearchTool
    ...
    async def _connect_mcp(self) -> None:
        ...
        from summerclaw.agent.tools.mcp import connect_mcp_servers
    ...
    def _tool_hint(tool_calls: list) -> str:
        ...
        from summerclaw.utils.tool_hints import format_tool_hints
    ...
    async def _process_message(
        ...
        if _should_plan:
            ...
            while True:
                ...
                from summerclaw.agent.evaluator import EvalDecision
