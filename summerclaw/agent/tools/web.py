...
from summerclaw.agent.tools.schema import IntegerSchema, StringSchema, tool_parameters_schema
from summerclaw.utils.helpers import build_image_content_blocks

if TYPE_CHECKING:
    from summerclaw.config.schema import WebSearchConfig
        ...
        try:
            async with httpx.AsyncClient(proxy=proxy_url, follow_redirects=True, max_redirects=MAX_REDIRECTS, timeout=15.0) as client:
                async with client.stream("GET", url, headers={"User-Agent": USER_AGENT}) as r:
                    from summerclaw.security.network import validate_resolved_url
