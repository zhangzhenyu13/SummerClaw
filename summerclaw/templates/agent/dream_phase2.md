...
- [SKILL] entries: create a new skill under skills/dreamed-<name>/SKILL.md using write_file
...
- Use write_file to create skills/dreamed-<name>/SKILL.md
- Skill directory name MUST start with `dreamed-` prefix (e.g., `dreamed-git-patch-apply`)
