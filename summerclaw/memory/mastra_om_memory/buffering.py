...
class BufferingStore:
    ...
    Here we use in-memory storage for simplicity, compatible with summerclaw's
...
async def async_buffer_observe(
    ...
    """
    import uuid
    from summerclaw.memory.mastra_om_memory.groups import build_message_range, wrap_in_observation_group
