"""MastraOM memory algorithm — Observational Memory for summerclaw.
...
class MastraOMMemoryAlgorithm(MemoryAlgorithm):
    ...
    - No external dependencies beyond summerclaw standard stack

    Configuration uses summerclaw's standard config:
