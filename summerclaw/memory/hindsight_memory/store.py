...
from summerclaw.memory.naive_memory.store import MemoryStore as _NaiveStore
...
class HindsightStore(_NaiveStore):
    ...
    def __init__(
        ...
        *,
        ...
        # ``logger.disable("summerclaw")`` silences the parent namespace.
        logger.enable("summerclaw.memory.hindsight_memory")
