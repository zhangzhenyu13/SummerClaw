"""Naive Dream — heavyweight cron-scheduled memory consolidation.
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from summerclaw.agent.tools.filesystem import EditFileTool, ReadFileTool, SkillPrefixWriteFileTool
