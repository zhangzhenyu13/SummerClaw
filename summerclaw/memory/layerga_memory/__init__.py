"""Layerga memory algorithm — GenericAgent-style L0-L4 layered memory for summerclaw.
...
from summerclaw.memory.layerga_memory.decision_tree import L0DecisionTree
...
class LayergaMemoryAlgorithm(MemoryAlgorithm):
    ...
    the standard summerclaw file I/O stack.
    """
