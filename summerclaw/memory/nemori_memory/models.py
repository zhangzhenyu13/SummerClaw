"""Domain models for Nemori memory algorithm — adapted for summerclaw.

Ported from nemori (https://github.com/nemori-ai/nemori) and adapted
to fit summerclaw's type system and LLM provider conventions.
"""
...
class Message:
    ...
    @classmethod
    def from_summerclaw_message(cls, msg: dict[str, Any]) -> Message:
        """Convert a summerclaw session message dict into a nemori Message."""
