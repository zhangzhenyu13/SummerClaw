...
This directory contains built-in skills that extend SummerClaw's capabilities.
...
When skills reference large local documentation or logs, prefer SummerClaw's built-in
...
| `web-search-2.0` | Search from baidu/bing/etc. via playwright |