...
echo "summerclaw line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "summerclaw/agent")
core_bus=$(count_top_level_py_lines "summerclaw/bus")
core_config=$(count_top_level_py_lines "summerclaw/config")
core_cron=$(count_top_level_py_lines "summerclaw/cron")
core_heartbeat=$(count_top_level_py_lines "summerclaw/heartbeat")
core_session=$(count_top_level_py_lines "summerclaw/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "summerclaw/agent/tools")
extra_skills=$(count_skill_lines "summerclaw/skills")
extra_api=$(count_recursive_py_lines "summerclaw/api")
extra_cli=$(count_recursive_py_lines "summerclaw/cli")
extra_channels=$(count_recursive_py_lines "summerclaw/channels")
extra_utils=$(count_recursive_py_lines "summerclaw/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under summerclaw/agent"
echo "  - tools/ is counted separately from summerclaw/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, summerclaw.py, root files"
