...
import os
from summerclaw.utils.path import abbreviate_path
...
class TestAbbreviatePathWindows:
    def test_windows_drive_path(self):
        path = "D:\\Documents\\GitHub\\summerclaw\\src\\utils\\helpers.py"
    ...
    def test_windows_home(self):
        home = os.path.expanduser("~")
        path = os.path.join(home, ".summerclaw", "workspace", "log.txt")
