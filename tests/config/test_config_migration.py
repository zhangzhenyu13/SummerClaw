...
from summerclaw.config.loader import load_config, save_config
from summerclaw.security.network import validate_url_target
...
def test_onboard_does_not_crash_with_legacy_memory_window(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("summerclaw.config.loader.get_config_path", lambda: config_path)
    monkeypatch.setattr("summerclaw.cli.commands.get_workspace_path", lambda _workspace=None: workspace)
