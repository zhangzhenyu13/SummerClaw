...
table, allowing summerclaw to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from summerclaw.channels import feishu
...
from summerclaw.channels.feishu import FeishuChannel
