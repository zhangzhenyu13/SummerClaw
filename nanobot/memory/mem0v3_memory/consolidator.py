...
Implements the full mem0 v3 extraction pipeline adapted for nanobot.
"""
...
from nanobot.memory.mem0v3_memory.prompts import (
...
class Mem0V3Consolidator:
    ...
    def search(self, query: str, *, top_k: int = 20, threshold: float = 0.1) -> list[dict]:
        ...
        scored = _score_and_rank(
            ...
            entity_boosts=entity_boosts, threshold=threshold, top_k=top_k,
        )
