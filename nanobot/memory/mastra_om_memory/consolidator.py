...
This is the nanobot-adapted version that works with SessionManager, file-based
...
class MastraOMConsolidator:
    ...
    def build_context_system_messages(
        ...
        from nanobot.memory.mastra_om_memory.groups import parse_observation_groups
